...
describe("SessionComposer", () => {
  it("renders member and project selects and validates prompt", async () => {
    ...
    await waitFor(() => expect(createTask).toHaveBeenCalledWith(expect.objectContaining({ prompt: "hello" })));
