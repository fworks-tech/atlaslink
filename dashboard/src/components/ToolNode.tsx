...
export function ToolNode(props: NodeProps) {
  ...
  return (
    <div className="w-[160px] border border-sky-400/30 bg-sky-500/10 p-2.5 shadow-lg" style={{ clipPath: "polygon(10% 0,100% 0,90% 100%,0 100%)" }}>
      ...
      <div className="mt-1 truncate text-[11px] font-medium text-foreground">{name}</div>
