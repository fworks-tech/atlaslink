...
export function DecisionNode(props: NodeProps) {
  ...
  return (
    <div className="flex h-[80px] w-[80px] items-center justify-center border border-violet-400/40 bg-violet-500/10 p-2 shadow-lg" style={{ clipPath: "polygon(50% 0,100% 50%,50% 100%,0 50%)" }}>
      ...
      <div className="text-center">
        ...
        <div className="mt-0.5 line-clamp-2 text-[10px] leading-tight text-foreground">{outcome.slice(0, 40)}</div>
      </div>
