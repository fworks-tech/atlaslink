...
in the config (currently opencode-go, with Groq among the fallbacks). See
ADR-008 and ADR-009 in the agenthood repo
([`docs/adr/`](../agenthood/docs/adr/)) for design decisions.
...
[ADR-015](../agenthood/docs/adr/ADR-015-decision-intelligence-and-provenance.md) and
[decision-intelligence.md](../agenthood/docs/architecture/decision-intelligence.md).
